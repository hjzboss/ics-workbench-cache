...
CFLAGS += -O1 -std=gnu11 -ggdb -Wall -Werror -Wno-unused-result -Wno-unused-value -Wno-unused-variable -Wno-missing-braces
...
clean:
	rm -rf $(NAME)-64 $(NAME)-32 $(NAME)-64.so $(NAME)-32.so ./log/*
